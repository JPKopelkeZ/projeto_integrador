...
public class TelaInicialVendedor extends JFrame {
	...
	public TelaInicialVendedor(Usuario usuario) {
			...
			public void actionPerformed(ActionEvent e) {
				if (txtPesquisarProduto.getText().equals("")) {
					...
					for (int i = 0; i < listaLivro.size(); i++) {
						...
						model.addRow(new Object[] { l.getCodigo(), l.getTitulo(), l.getAutor(), l.getGenero(),
								l.getIdioma(), l.getAno(), l.getnPaginas(), l.getEditora(), l.getPreco() });
		...
		table = new JTable();
		model = new DefaultTableModel(new Object[][] {}, new String[] { "C\u00F3digo", "T\u00EDtulo", "Autor",
				"G\u00EAnero", "Idioma", "Ano", "N\u00B0 P\u00E1ginas", "Editora", "Pre\u00E7o" });
		table.setModel(model);
		for (int i = 0; i < listaLivro.size(); i++) {
			Livro l = listaLivro.get(i);

			model.addRow(new Object[] { l.getCodigo(), l.getTitulo(), l.getAutor(), l.getGenero(), l.getIdioma(),
					l.getAno(), l.getnPaginas(), l.getEditora(), l.getPreco() });
